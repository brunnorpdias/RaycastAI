...
export declare function trainingParametersInToJSON(trainingParametersIn: TrainingParametersIn): string;
export declare function trainingParametersInFromJSON(jsonString: string): SafeParseResult<TrainingParametersIn, SDKValidationError>;
