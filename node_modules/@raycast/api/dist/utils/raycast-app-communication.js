...
`);for(let c of a){let f=c.indexOf("/Contents/MacOS/Raycast");if(f>-1&&(c=c.substring(0,f)),!!d.existsSync(c))if(0)try{}catch(Ke){}else return!0}return!1}0&&(module.exports={commFilePath,notifyRaycast,updatePid});
